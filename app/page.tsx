  ...
  return (
    <>
      ...
      <section className="bg-[rgb(194,196,254)] container top-15 relative min-h-screen p-4 w-[92%] mx-auto over-flow:hidden rounded-xl m-10">
        ...
        {/* Main Grid Layout */}
        <div className="w-[90%] mx-auto mt-15 grid grid-cols-1 md:grid-cols-12 gap-6">
          {/* Left Column */}
          <div className="md:col-span-3 space-y-6">
            ...
            {/* Brand and CTA */}
            <div className="space-y-4 absolute mt-30">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            {/* Designer CTA */}
            <div>
              <h2 className="text-blue-800 text-xl font-medium absolute mt-45">
                Consult With Our
                <br />
                Interior Designers →
              </h2>
