          ...
          <nav className="hidden md:block">
            <ul className="flex gap-12 text-white text-xl cursor-pointer">
              <li className="hover:underline">
                <a target="_blank" rel="noopener noreferrer" href="https://cdn.botpress.cloud/webchat/v2.5/shareable.html?configUrl=https://files.bpcontent.cloud/2025/05/03/15/20250503155210-ZH6Y3LBH.json">
                  Home
                </a>
              </li>
              <li className="hover:underline">
